    ...
    public int checkObjeto(Entity entity, boolean player) {
        ...
        for (int i = 0; i < gp.obj.length; i++) {
            ...
            if (gp.obj[i] != null) {
                ...
                // posicion solida del area de la entidad
                entity.solidArea.x = entity.worldX + entity.solidArea.x;
                entity.solidArea.y = entity.worldY + entity.solidArea.y;

                // posicion solida del area del objeto
                ...
                switch (entity.direction) {
                    case "up":
                        ...
                        if(entity.solidArea.intersects(gp.obj[i].solidArea)){  //esto comprueba si estan colisionando el player y el objeto
